...
func (_Facade *FacadeTransactor) GetWorkExperienceBySecurityNo(opts *bind.TransactOpts, securityNo [32]byte) (*types.Transaction, error) {
	return _Facade.contract.Transact(opts, "getWorkExperienceBySecurityNo", securityNo)
}

// GetWorkExperienceBySecurityNo is a paid mutator transaction binding the contract method 0xabaed258.
//
// Solidity: function getWorkExperienceBySecurityNo(bytes32 securityNo) returns((uint16,uint16,bool,bytes32)[])
func (_Facade *FacadeSession) GetWorkExperienceBySecurityNo(securityNo [32]byte) (*types.Transaction, error) {
	return _Facade.Contract.GetWorkExperienceBySecurityNo(&_Facade.TransactOpts, securityNo)
}

// GetWorkExperienceBySecurityNo is a paid mutator transaction binding the contract method 0xabaed258.
//
// Solidity: function getWorkExperienceBySecurityNo(bytes32 securityNo) returns((uint16,uint16,bool,bytes32)[])
func (_Facade *FacadeTransactorSession) GetWorkExperienceBySecurityNo(securityNo [32]byte) (*types.Transaction, error) {
	return _Facade.Contract.GetWorkExperienceBySecurityNo(&_Facade.TransactOpts, securityNo)
}
